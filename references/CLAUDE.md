...
| `scoring.md` | reading the score table (thresholds, the "0 = not applicable" convention, run-comparison) | [`edd:run`](../skills/run/SKILL.md) |
...
| "Why is this judge red? / is this red real?" | `failure-modes.md` (then `scoring.md` for table mechanics) |
